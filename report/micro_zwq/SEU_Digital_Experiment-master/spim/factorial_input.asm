...
doit:
    ...
    jr   $ra
main:
    la $v0, 4            # system call for print_str
    la $a0, input        # address of the copyright notice
    syscall              # print the copyright notice
    
    li   $v0, 5          # set as reading input
    syscall              # input
    
    move $a0, $v0        # set the argument for the factorial function to the input value
    ...
    la $v0, 4            # system call for print_str
    la $a0, note         # address of the copyright notice
    syscall              # print the copyright notice
